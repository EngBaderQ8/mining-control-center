...
export const EN: Record<string, string> = {
  ...
  "حفظ": "Save",
  "إلغاء": "Cancel",
  "✏️ تعديل الاسم": "✏️ Rename",
  "تغيير اسم الموقع": "Rename this site",
  "تم تغيير اسم الموقع": "Site renamed",
  ...
  "🌡️ حسّاسات": "🌡️ Sensors",
  "حسّاسات حرارة/رطوبة الغرفة": "Room temperature/humidity sensors",
  "حرارة/رطوبة الغرفة": "Room temperature/humidity",
  "حسّاسات الغرفة — {name}": "Room sensors — {name}",
  "حسّاس Shelly على شبكة الموقع — لابتوب الموقع يقرأه ويحذّرك لو حرارة/رطوبة الغرفة تجاوزت الحد. نصيحة: شغّل Shelly Plus H&T على كيبل USB ليبقى صاحياً.":
    "A Shelly sensor on the site's network — the site laptop reads it and warns you if room temperature/humidity crosses the limit. Tip: power a Shelly Plus H&T over USB so it stays awake.",
  "الاسم": "Name",
  "IP الحسّاس": "Sensor IP",
  "حد الحرارة °": "Temp limit °",
  "حد الرطوبة %": "Humidity limit %",
  "القراءة": "Reading",
  "غرفة الحاويات": "Container room",
  "حذف": "Delete",
  "القراءة —": "Reading —",
  "— لم يُقرأ بعد": "— not read yet",
  "⚠ لا يستجيب": "⚠ not responding",
  "حسّاس": "Sensor",
  "ما فيه حسّاسات بعد — أضِف واحداً.": "No sensors yet — add one.",
  "+ إضافة حسّاس": "+ Add sensor",
