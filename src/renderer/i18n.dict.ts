...
export const EN: Record<string, string> = {
  ...
  "تنبيهات على هاتفك عبر تيليجرام": "Alerts on your phone via Telegram",
  "تنبيهات الهاتف": "Phone alerts",
  ...
  "فشل": "Failed",
  "✅ أُرسل التقرير اليومي على تيليجرام — شوف هاتفك.": "✅ The daily report was sent on Telegram — check your phone.",
  "تنبيهات الهاتف عبر تيليجرام": "Phone alerts via Telegram",
  "يوصلك إشعار على هاتفك فوراً لما يتوقف جهاز أو يسخن أو ينزل الهاش.": "You get a notification on your phone instantly when a device stops, overheats, or the hashrate drops.",
  ...
  "الأقوى — تتحكم من هاتفك:": "The best part — control it from your phone:",
